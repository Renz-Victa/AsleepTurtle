...
const services = [
  {
    ...
    why: 'Most teams waste months evaluating the wrong things. We compress that into a structured sprint that ends with clear decisions.',
  ...
  return (
    <>
      ...
      <section className="section section--white"><div className="container">
        <p className="svc-intro">We work with a number of clients at any given time. That is not a sales line, it is how we ensure senior attention on every project.</p>
        {services.map((s) => (
      ...
      <section className="section"><div className="container">
        <div className="cta-band">
          <p className="cta-band__label">Not sure what fits?</p>
